...
//	gửi yêu cầu từ khách hàng (client) tới máy chủ và xử lý phản hồi từ máy chủ.
...
//	thoát khỏi ứng dụng của (client)
...
//	sử dụng để cập nhật danh sách bạn bè trong giao diện chính (MainFrame). 
