...
public class StartClientFrame extends JFrame implements ActionListener {
	...
	public StartClientFrame() {
		...
		txtIP.setForeground(new Color(255, 0, 0));
		...
		txtPort.setForeground(new Color(255, 165, 0));
		...
		comboBox.setForeground(new Color(0, 255, 127));
		// Read Data
		String[] data = null;
		try {
			data = readFileServer();
		...
		btnConnectServer.setBackground(new Color(135, 206, 250));
		btnConnectServer.setForeground(new Color(255, 69, 0));
