...
//Tạo và mã hóa các thẻ trong giao thức truyền thông để truyền các yêu cầu, thông điệp hoặc tệp tin giữa người dùng và 
//máy chủ tạo và mã hóa các thẻ trong giao thức truyền thông để truyền các yêu cầu, thông điệp hoặc tệp tin giữa người dùng và máy chủ
public class Encode {

	private static Pattern checkMessage = Pattern.compile("[^<>]*[<>]");
//	Nhận vào tên người dùng và cổng và trả về một chuỗi đã được mã hóa với các thẻ tương ứng
...
//	Phương thức này cũng thực hiện một số xử lý để tách các phần tử con trong thông điệp và bao gồm chúng trong chuỗi mã hóa.
...
//	Là một yêu cầu gửi từ người dùng tới máy chủ để bắt đầu cuộc trò chuyện.
...
//	 Là một yêu cầu gửi tệp từ người dùng tới máy chủ.
	public static String sendFile(String name) {
		return Tags.FILE_REQ_OPEN_TAG + name + Tags.FILE_REQ_CLOSE_TAG;
	}
//	Là một yêu cầu thoát khỏi hệ thống từ người dùng tới máy chủ.
